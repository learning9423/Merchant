...
class AbleSale(unittest.TestCase):
    ...
    def test_ableSale2(self):
        '''商品id错误'''
        token = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE1ODY0MTI0NDQsInNjb3BlIjpbImdldCIsInBvc3QiXSwidWlkIjoiNTI0IiwidU5hbWUiOiJhcTk0MjMifQ.xOyVDsRovgHeIS1RSHlZ-fmPX9jG6p__Lpq42PcJShgR'
    ...
    def test_ableSale3(self):
        '''token错误'''
        token = 'e'
        ableSale_data = {'token': token, 'goods_list': self.find_one()}
