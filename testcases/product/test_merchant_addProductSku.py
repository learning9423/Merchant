...
class AddProductSku(unittest.TestCase):
    ...
    def test_addProductSku1(self):
        ...
        expect_result=addProductSku_data[0]['expect_result'].split(":")[1]
    ...
    def test_addProductSku3(self):
        ...
        expect_result=addProductSku_data[2]['expect_result'].split(":")[1]
        msg=addProductSku_data[2]['msg'].split(":")[1]+':'+addProductSku_data[2]['msg'].split(":")[2]
        self.assertEqual(r.json()['execute_status'], eval(expect_result),msg=r.json())
    ...
    def test_addProductSku4(self):
        ...
        expect_result=addProductSku_data[3]['expect_result'].split(":")[1]
