...
class UpdateRegionShippingFee(unittest.TestCase):
    ...
    def test_updateRegionShippingFee1(self):
        ...
        expect_result = updateRegionShippingFee_data[0]['expect_result'].split(":",1)[1]
        msg = updateRegionShippingFee_data[0]['msg'].split(":",1)[1]
    ...
    def test_updateRegionShippingFee2(self):
        ...
        expect_result = updateRegionShippingFee_data[1]['expect_result'].split(":",1)[1]
    ...
    def test_updateRegionShippingFee3(self):
        ...
        expect_result = updateRegionShippingFee_data[2]['expect_result'].split(":",1)[1]
