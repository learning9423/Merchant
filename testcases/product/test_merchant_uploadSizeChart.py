...
class UploadSizeChart(unittest.TestCase):
    ...
    def test_uploadSizeChart1(self):
        ...
        expect_result = uploadSizeChart_data[0]['expect_result'].split(":",1)[1]
        msg = uploadSizeChart_data[0]['msg'].split(":",1)[1]
    ...
    def test_uploadSizeChart2(self):
        ...
        expect_result = uploadSizeChart_data[1]['expect_result'].split(":",1)[1]
    ...
    def test_uploadSizeChart3(self):
        ...
        expect_result = uploadSizeChart_data[2]['expect_result'].split(":",1)[1]
        msg = uploadSizeChart_data[2]['msg'].split(":",1)[1]
        self.assertEqual(r.json()['execute_status'], eval(expect_result),msg=r.json())
        self.assertEqual(r.json()['message'],eval(msg),msg=r.json())
    ...
    def test_uploadSizeChart4(self):
        ...
        expect_result = uploadSizeChart_data[3]['expect_result'].split(":",1)[1]
