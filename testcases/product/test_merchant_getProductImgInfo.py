...
class GetProductImgInfo(unittest.TestCase):
    ...
    def test_getProductImgInfo1(self):
        ...
        expect_result = getProductImgInfo_data[0]['expect_result'].split(":")[1]

        msg = getProductImgInfo_data[0]['msg'].split(":")[1]
    ...
    def test_getProductImgInfo2(self):
        ...
        expect_result=getProductImgInfo_data[1]['expect_result'].split(":")[1]
    ...
    def test_getProductImgInfo3(self):
        ...
        expect_result = getProductImgInfo_data[2]['expect_result'].split(":")[1]
        msg = getProductImgInfo_data[2]['msg'].split(":")[1]
        self.assertEqual(r.json()['product_id'], eval(expect_result), msg=r.json())
        self.assertEqual(r.json()['message'], eval(msg), msg=r.json())
