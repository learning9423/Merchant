...
class DisableSale(unittest.TestCase):
    ...
    def test_disableSale1(self):
        ...
        expect_result=disableSale_data[0]['expect_result'].split(":")[1]
        msg=disableSale_data[0]['msg'].split(":")[1]
    ...
    def test_disableSale2(self):
        ...
        expect_result=disableSale_data[1]['expect_result'].split(":")[1]
        msg=disableSale_data[1]['msg'].split(":")[1]
    ...
    def test_disableSale3(self):
        ...
        expect_result=disableSale_data[2]['expect_result'].split(":")[1]
        msg=disableSale_data[2]['msg'].split(":")[1]
    ...
    def test_disableSale4(self):
        ...
        expect_result=disableSale_data[3]['expect_result'].split(":")[1]
        msg=disableSale_data[3]['msg'].split(":")[1]
    ...
    def test_disableSale5(self):
        ...
        expect_result=disableSale_data[4]['expect_result'].split(":")[1]
